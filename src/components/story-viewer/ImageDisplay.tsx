...
const ImageDisplay: React.FC<ImageDisplayProps> = ({
    ...
    const isRealImageUrl = imageUrl && 
                          ...
                          imageUrl.includes('supabase.co/storage'); // Must be from Supabase storage
    
    console.log(`[ImageDisplay ${segmentId}] URL Analysis:`, {
        isRealImageUrl,
        urlContainsSupabase: imageUrl?.includes('supabase.co/storage'),
        imageUrl
    });
    ...
    return (
        <div className="rounded-lg aspect-square col-span-1 relative bg-secondary overflow-hidden border">
            ...
            {process.env.NODE_ENV === 'development' && imageGenerationStatus === 'completed' && (
