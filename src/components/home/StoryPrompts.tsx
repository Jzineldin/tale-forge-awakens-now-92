        ...
        <div className="grid grid-cols-1 gap-6">
          {prompts.map((prompt, index) => (
            <Button
              key={index}
              variant="outline"
              className="group h-auto p-6 text-left bg-gradient-to-r from-amber-400/20 to-purple-400/20 border-2 border-amber-400/50 hover:from-amber-400/30 hover:to-purple-400/30 hover:border-amber-400/70 transition-all duration-300 backdrop-blur-md rounded-xl shadow-xl hover:shadow-amber-400/20 hover:scale-[1.02] transform-gpu"
