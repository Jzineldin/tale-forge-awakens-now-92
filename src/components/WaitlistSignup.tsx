        ...
        <CardContent className="p-6 text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-green-200 leading-relaxed">
              Thank you for joining our waitlist. We'll notify you as soon as new features like 
              AI voice narration and dynamic visuals are ready to experience.
            </p>
          </div>
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <p className="text-xs text-amber-200/80 text-center leading-relaxed">
          Get notified when AI voice narration and dynamic visuals are ready
        </p>
      </form>
    </Form>
  );
    ...
    <Card className={`${className} border-amber-500/40 bg-amber-50/10 backdrop-blur-sm shadow-2xl hover:shadow-3xl transition-all duration-300`}>
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-amber-100 leading-relaxed">
          Be the first to experience AI voice narration and dynamic visuals when they launch
        </CardDescription>
      </CardHeader>
      <CardContent>
        {formContent}
